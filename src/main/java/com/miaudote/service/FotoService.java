...
public class FotoService {
    ...
    public List<FotoResponseDTO> getFotosPorPagina(Long usuarioId, int pagina) {
        ...
        Page<Animal> paginas = animalRepository.findPaginasByStatus(pageable, Animal.Status.Disponível);
    ...
    public List<FotoResponseDTO> getFotosFavoritos(Long adotanteId, int pagina) {
        ...
        Page<Favorito> paginas = favoritoRepository.findPaginasByAdotanteIdAndAnimalStatus(pageable, adotanteId, Animal.Status.Disponível);
        int totalPaginas = paginas.getTotalPages();
